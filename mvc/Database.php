...
class Database
{
	...
	function __construct()
	{
		...
		//$this->magic_quotes_active = get_magic_quotes_gpc(); //this one used for?
		// $this->real_escape_string_exists = function_exists("mysqli_real_escape_string"); //what is this used for ?
	}
